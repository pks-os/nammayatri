...
WITH MerchantMessages AS (
  SELECT T1.merchant_id, 'METRO_TICKET_BOOKING_CANCELLED', 'You have successfully cancelled your metro {#URL#} and the refund is in progress. Please visit {#URL#} to view details. Thank you for choosing Namma Yatri! -Namma Yatri', T1.id ,'NMYTRI'
