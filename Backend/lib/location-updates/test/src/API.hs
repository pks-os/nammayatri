...
successFlow appEnv config eps expectedDistance rideId route = runFlow "" appEnv $ do
  ...
  finalDistanceCalculation ih Nothing False rideId testDriverId destination 0 Nothing Nothing True Nothing
...
failFlow appEnv config rideId route = runFlow "" appEnv $ do
  ...
  finalDistanceCalculation ih Nothing rideId testDriverId destination 0 Nothing True Nothing
