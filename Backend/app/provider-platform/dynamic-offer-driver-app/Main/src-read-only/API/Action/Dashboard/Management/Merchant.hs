...
postMerchantConfigSpecialLocationUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.UpsertSpecialLocationCsvReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantConfigSpecialLocationUpsert a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigSpecialLocationUpsert a3 a2 a1
