...
data DuplicateCoinsConfigsReq = DuplicateCoinsConfigsReq {entriesId :: Kernel.Types.Id.Id Dashboard.Common.CoinsConfig, eventFunction :: Dashboard.Common.DriverCoins.DriverCoinsFunctionType}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
