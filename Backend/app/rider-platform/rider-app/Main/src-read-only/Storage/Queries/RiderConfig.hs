...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.postRideSafetyNotificationExpireTime ((Kernel.Utils.Common.nominalDiffTimeToSeconds <$>) postRideSafetyNotificationExpireTime),
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            postRideSafetyNotificationExpireTime = (Kernel.Utils.Common.secondsToNominalDiffTime <$> postRideSafetyNotificationExpireTime),
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.postRideSafetyNotificationExpireTime = (Kernel.Utils.Common.nominalDiffTimeToSeconds <$>) postRideSafetyNotificationExpireTime,
