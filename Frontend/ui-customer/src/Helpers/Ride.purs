...
feedBack id vehicleVariant  = case id of 
                              ...
                              "11" -> case vehicleVariant of 
                                      ...
                                      _ -> if isAmbulance vehicleVariant then getString UNCOMFORTABLE_AMBULANCE else  getString LT.UNCOMFORTABLE_CAB
                              "12" -> case vehicleVariant of 
                                      "AUTO_RICKSHAW" -> getString CLEAN_AUTO
                                      "BIKE" -> getString CLEAN_BIKE
                                      _ -> if isAmbulance vehicleVariant then getString CLEAN_AMBULANCE else getString CLEAN_CAB
                              _ -> ""
